...
if st.button("Generate Quote"):
    ...
    layout_image = InlineImage(doc, f"layout_{robot_arms}_arms.png", width=Mm(150))
    layout_overview_image = InlineImage(doc, f"overview_{robot_arms}_arms.png", width=Mm(150))
    robot_model_image = InlineImage(doc, "fanuc_m20id25.png", width=Mm(60))
    ...
    gripper_image = InlineImage(doc, gripper_filename, width=Mm(150))
