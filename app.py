...
steps = ["Proposal Info", "System Config", "Technical Specs", "Shipping & Timeline", "Inclusions & Quote"]
...
# --- WR Branding ---
logo = Image.open("logoWasteRobotics(1).png")
col1, col2 = st.columns([1, 6])
with col1:
        ...
        try:
            ...
            context = {
                **fd,
                ...
                "vision_system": ", ".join(fd["vision_system"]),
